...
description: >
  ...
  Covers reporting a confirmed NeOS bug upstream — see reporting.md.
---
...
## If it is an NeOS bug

Most application crashes are upstream bugs in those applications, not NeOS's
doing. In the minority of cases where the cause really does sit within NeOS's
