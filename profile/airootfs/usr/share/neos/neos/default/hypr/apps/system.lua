...
o.window(
  "(org.neos.btop|org.neos.terminal|org.neos.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|NeOS|About|TUI.float|imv|mpv)",
  {
    tag = "+floating-window",
  }
)
...
-- This size only covers the first launch: neos-launch-about measures the
-- rendered content, remembers the size that hugs it, and applies that as its own
-- rule before every later launch.
o.window("org.neos.about", { float = true })
o.window("org.neos.about", { center = true })
o.window("org.neos.about", { size = { 920, 480 } })
...
o.window("org.neos.screensaver", { fullscreen = true })
o.window("org.neos.screensaver", { float = true })
o.window("org.neos.screensaver", { animation = "slide" })
