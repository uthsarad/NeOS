...
local nvidia = paths.neos_path .. "/bin/neos-hw-nvidia"
local nvidia_gsp = paths.neos_path .. "/bin/neos-hw-nvidia-gsp"
local nvidia_without_gsp = paths.neos_path .. "/bin/neos-hw-nvidia-without-gsp"
