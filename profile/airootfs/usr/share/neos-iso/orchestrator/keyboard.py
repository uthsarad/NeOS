...
produces the part of that output NeOS actually consumes — KEYMAP for the
console plus the XKB* settings in vconsole.conf that neos's
...
generated: nothing on an NeOS system reads it.
"""
