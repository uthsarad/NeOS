...
The overall project is accumulating validation debt. Strict systemd sandboxing was recently implemented for `neos-autoupdate.service` and `neos-liveuser-setup.service`, but specialist reviews (Sentinel for security auditing, Palette for logging UX) remain pending.
