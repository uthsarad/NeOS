...
# NOTE: the GRUB theme font (neos.pf2) is a committed asset generated by
# tools/gen-grub-theme.py — NOT generated here — because CI builds with
# mkarchiso directly and never runs this script.
